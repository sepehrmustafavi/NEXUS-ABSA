...
class Config:
    ...
    # Format: (ID, Model_Path, Arch_Type, Strategy, Knowledge_Source, Dataset)
    # ---------------------------------------------------------
    ROBERTA_PATH = os.path.join(MODELS_DIR, "roberta-base")
    DEBERTA_PATH = os.path.join(MODELS_DIR, "deberta-v3-base")
    QWEN_PATH = os.path.join(MODELS_DIR, "Qwen2-0.5B")
